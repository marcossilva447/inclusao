...
// Variáveis para armazenar as ações em espera
int proximaAcao = 0;
int elementoParaReproduzir = 0;
...
void loop() {
    ...
    if (!isPlaying) {
        ...
        if (myDFPlayer.readState() == 512) { // 512 é o código para stop
            isPlaying = false;
            ...
            delay(20000); // Delay maior para evitar múltiplas leituras do botão
        }
    }
}
