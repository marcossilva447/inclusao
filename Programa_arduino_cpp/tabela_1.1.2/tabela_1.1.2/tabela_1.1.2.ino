...
void loop() {
    ...
    if (estadoBotaoNext == LOW) {
        ...
        delay(5000); // Delay maior para evitar múltiplas leituras do botão
        ...
        if (elementoAtual != 0) {
            ...
            delay(5000); // Delay maior para evitar travamento
        }

        delay(5000); // Pequeno atraso para evitar movimentos muito rápidos
    }
}
